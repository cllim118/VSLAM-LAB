...
class MALESIA_dataset(DatasetVSLAMLab):
    """MALESIA dataset helper for VSLAM-LAB benchmark with local images."""

    def __init__(self, benchmark_path: str | Path, dataset_name: str = "malesia") -> None:
    ...
    def download_sequence_data(self, sequence_name: str) -> None:
        """Format local images into VSLAM-LAB structure."""
        ...
        print(f"Formatting {len(images)} images into VSLAM format...")
        ...
        # Generate CSV and calibration files
